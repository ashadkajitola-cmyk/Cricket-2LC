    ...
    <div id="dashboardSection" class="hidden">
        ...
        <div id="adminPanelSection" class="card hidden" style="border: 2px solid var(--accent); background: #fff;">
            ...
            <div class="admin-section-box">
                ...
                <input type="text" id="groupNameInput" placeholder="Group Name (jaise: Group A / Super 8)">
                <input type="text" id="groupTeamsInput" placeholder="Teams comma se alag karein (jaise: IND, PAK, AUS, ENG)">
            ...
            <!-- OPTION 4: POINTS TABLE UPDATE (ICC FORMULA) -->
            <div class="admin-section-box">
                <h4>4. Points Table Update (ICC Formula)</h4>
                
                <label style="font-size: 12px; font-weight: bold; color: #333; display: block; margin-top: 5px;">Pehle Group Chunein:</label>
                <select id="ptGroupSelect">
                    <option value="">-- Group Chunein --</option>
                </select>

                <label style="font-size: 12px; font-weight: bold; color: #333; display: block; margin-top: 8px;">Team Chunein:</label>
                ...
                <button class="action-btn" id="savePointTableTeamBtn" style="margin-top: 10px; background: var(--primary-dark);">Team Points Update Karein</button>
